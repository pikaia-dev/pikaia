    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Sign in without a password using Face ID, Touch ID, or your device PIN.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex items-center gap-3 rounded-lg border border-amber-200 bg-amber-50 p-4 text-amber-800 dark:border-amber-900 dark:bg-amber-950 dark:text-amber-200">
            ...
            <p className="text-sm">
              Passkeys are not supported in this browser. Try using Chrome, Safari, or Edge on a
              recent version.
            </p>
          </div>
        </CardContent>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap items-center gap-x-3 gap-y-1 mt-1.5 text-sm text-muted-foreground">
                        <span className="flex items-center gap-1.5">
                          ...
                          Added{' '}
                          {formatDistanceToNow(new Date(passkey.created_at), { addSuffix: true })}
                        </span>
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          This will remove "{passkey.name}" from your account. You won't be able to
                          sign in with this passkey anymore.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
                        ...
                        <AlertDialogAction
                          onClick={() => {
                            handleDeleteClick(passkey.id, passkey.name)
                          }}
