...
export function WebhookEndpointsList({
    ...
    const handleSendTest = (eventType: string) => {
        ...
        testMutation.mutate(
            ...
            { onSettled: () => { setTestDialogOpen(false); setEndpointToTest(null); } }
        )
    }
                                        ...
                                        <td className="p-3 text-right">
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent align="end">
                                                    ...
                                                    <DropdownMenuItem onClick={() => { openTestDialog(endpoint); }}>
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ...
                            <strong>{endpointToDelete?.name}</strong>? This action cannot be
            ...
            <AlertDialog open={testDialogOpen} onOpenChange={setTestDialogOpen}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Select an event type to send to{" "}
                            <strong>{endpointToTest?.name}</strong>
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <div className="grid gap-2 py-4 max-h-64 overflow-y-auto">
                        {events.map((event) => (
                            <Button
                                ...
                                onClick={() => { handleSendTest(event.type); }}
