...
import { isWebAuthnSupported, usePasskeys, useRegisterPasskey } from '../hooks/usePasskeyAuth'
    ...
    >
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogTitle className="text-center">Enable passwordless login?</DialogTitle>
          <DialogDescription className="text-center">
            Add a passkey to sign in faster and more securely using Face ID, Touch ID, or your
            device PIN.
          </DialogDescription>
        </DialogHeader>
