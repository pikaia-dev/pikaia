      ...
      <div className="text-center space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            <span className="font-medium text-foreground">{email}</span> encountered an issue during
            setup.
          </p>
        </div>
  ...
  return (
    <div className="space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-sm text-muted-foreground">Choose which organization to sign in to</p>
      </div>
      ...
      <div className="space-y-2">
        {organizations.map((discoveredOrg) => {
          ...
          const membershipLabel = getMembershipLabel(discoveredOrg.membership.type)
