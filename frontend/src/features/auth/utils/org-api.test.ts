...
describe("createOrganization", () => {
    ...
    it("throws error with detail message on failure", async () => {
        ...
        await expect(
            createOrganization("ist_123", "My Org", "my-org")
...
describe("isConflictError", () => {
    it("returns true for slug conflict errors", () => {
        expect(isConflictError(new Error("Organization slug already exists"))).toBe(
            true
        )
    ...
    it("returns true for name conflict errors", () => {
        expect(isConflictError(new Error("Organization name already exists"))).toBe(
            true
        )
