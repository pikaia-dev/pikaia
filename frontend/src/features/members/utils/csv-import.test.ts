...
describe("parseRowsWithMappings", () => {
  it("parses rows with all columns mapped", () => {
    ...
    const mappings = { 0: "email" as const, 1: "name" as const, 2: "phone" as const, 3: "role" as const }
  ...
  it("handles real-world CSV data with assumed country code", () => {
    ...
    const mappings = { 0: "name" as const, 1: "email" as const, 2: "phone" as const, 3: "role" as const }
