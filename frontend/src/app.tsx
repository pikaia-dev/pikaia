...
const ProfileSettings = lazy(() => import('@/pages/settings/profile-settings'))
const OrganizationSettings = lazy(() => import('@/pages/settings/organization-settings'))
const MembersSettings = lazy(() => import('@/pages/settings/members-settings'))
...
const IntegrationsSettings = lazy(() => import('@/pages/settings/integrations-settings'))
