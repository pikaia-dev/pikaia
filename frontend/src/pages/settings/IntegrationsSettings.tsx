...
export default function IntegrationsSettings() {
    const { data: endpointsData, isLoading: endpointsLoading, error: endpointsError } = useWebhookEndpoints()
                ...
                <Card>
                    ...
                    <CardContent>
                        <p className="text-sm text-muted-foreground">
                            Configure webhook endpoints to receive HTTP POST requests when events like
                            member changes, billing updates, or organization changes occur.
