...
const DIAL_CODES: Record<string, string> = {
    ...
    BE: '+32', BZ: '+501', BJ: '+229', BT: '+975', BO: '+591', BA: '+387', BW: '+267',
    BR: '+55', BN: '+673', BG: '+359', BF: '+226', BI: '+257', KH: '+855', CM: '+237',
    CA: '+1', CV: '+238', CF: '+236', TD: '+235', CL: '+56', CN: '+86', CO: '+57',
    KM: '+269', CG: '+242', CR: '+506', HR: '+385', CU: '+53', CY: '+357', CZ: '+420',
    DK: '+45', DJ: '+253', DM: '+1', DO: '+1', EC: '+593', EG: '+20', SV: '+503',
    GQ: '+240', ER: '+291', EE: '+372', ET: '+251', FJ: '+679', FI: '+358', FR: '+33',
    GA: '+241', GM: '+220', GE: '+995', DE: '+49', GH: '+233', GR: '+30', GD: '+1',
    GT: '+502', GN: '+224', GW: '+245', GY: '+592', HT: '+509', HN: '+504', HK: '+852',
    HU: '+36', IS: '+354', IN: '+91', ID: '+62', IR: '+98', IQ: '+964', IE: '+353',
    IL: '+972', IT: '+39', JM: '+1', JP: '+81', JO: '+962', KZ: '+7', KE: '+254',
    KI: '+686', KP: '+850', KR: '+82', KW: '+965', KG: '+996', LA: '+856', LV: '+371',
    LB: '+961', LS: '+266', LR: '+231', LY: '+218', LI: '+423', LT: '+370', LU: '+352',
    MO: '+853', MK: '+389', MG: '+261', MW: '+265', MY: '+60', MV: '+960', ML: '+223',
    MT: '+356', MH: '+692', MR: '+222', MU: '+230', MX: '+52', FM: '+691', MD: '+373',
    MC: '+377', MN: '+976', ME: '+382', MA: '+212', MZ: '+258', MM: '+95', NA: '+264',
    NR: '+674', NP: '+977', NL: '+31', NZ: '+64', NI: '+505', NE: '+227', NG: '+234',
...
export const COUNTRIES: Country[] = [
    ...
    { code: 'AT', name: 'Austria', flag: '🇦🇹', dialCode: '+43', vatPrefix: 'ATU' },
    ...
    { code: 'BG', name: 'Bulgaria', flag: '🇧🇬', dialCode: '+359', vatPrefix: 'BG' },
    ...
    { code: 'HR', name: 'Croatia', flag: '🇭🇷', dialCode: '+385', vatPrefix: 'HR' },
    { code: 'CU', name: 'Cuba', flag: '🇨🇺', dialCode: '+53' },
    { code: 'CY', name: 'Cyprus', flag: '🇨🇾', dialCode: '+357', vatPrefix: 'CY' },
    { code: 'CZ', name: 'Czech Republic', flag: '🇨🇿', dialCode: '+420', vatPrefix: 'CZ' },
    ...
    { code: 'EE', name: 'Estonia', flag: '🇪🇪', dialCode: '+372', vatPrefix: 'EE' },
    { code: 'ET', name: 'Ethiopia', flag: '🇪🇹', dialCode: '+251' },
    { code: 'FJ', name: 'Fiji', flag: '🇫🇯', dialCode: '+679' },
    { code: 'FI', name: 'Finland', flag: '🇫🇮', dialCode: '+358', vatPrefix: 'FI' },
    ...
    { code: 'IE', name: 'Ireland', flag: '🇮🇪', dialCode: '+353', vatPrefix: 'IE' },
    ...
    { code: 'LT', name: 'Lithuania', flag: '🇱🇹', dialCode: '+370', vatPrefix: 'LT' },
    { code: 'LU', name: 'Luxembourg', flag: '🇱🇺', dialCode: '+352', vatPrefix: 'LU' },
    ...
    { code: 'NL', name: 'Netherlands', flag: '🇳🇱', dialCode: '+31', vatPrefix: 'NL' },
    ...
    { code: 'PT', name: 'Portugal', flag: '🇵🇹', dialCode: '+351', vatPrefix: 'PT' },
    ...
    { code: 'SK', name: 'Slovakia', flag: '🇸🇰', dialCode: '+421', vatPrefix: 'SK' },
    { code: 'SI', name: 'Slovenia', flag: '🇸🇮', dialCode: '+386', vatPrefix: 'SI' },
