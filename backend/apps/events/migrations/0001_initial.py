            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="events_audi_organiz_6f29d4_idx",
                    ),
                    models.Index(
                        fields=["aggregate_type", "aggregate_id"],
                        name="events_audi_aggrega_92f909_idx",
                    ),
                    models.Index(fields=["actor_id"], name="events_audi_actor_i_ef3de5_idx"),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "event_type",
                    models.CharField(
                        db_index=True, help_text="Event type, e.g. 'member.invited'", max_length=100
                    ),
                ),
                (
                    "aggregate_type",
                    models.CharField(help_text="Entity type, e.g. 'member'", max_length=50),
                ),
                (
                    "aggregate_id",
                    models.CharField(help_text="Entity ID, e.g. 'mbr_01HN...'", max_length=100),
                ),
                (
                    "organization_id",
                    models.CharField(
                        db_index=True, help_text="Tenant organization ID", max_length=100
                    ),
                ),
                (
                    "schema_version",
                    models.PositiveIntegerField(
                        default=1, help_text="Payload schema version for evolution"
                    ),
                ),
                (
                    "payload",
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, help_text="When the event was successfully published", null=True
                    ),
                ),
                (
                    "attempts",
                    models.PositiveIntegerField(default=0, help_text="Number of publish attempts"),
                ),
                (
                    "next_attempt_at",
                    models.DateTimeField(
                ...
                (
                    "last_error",
                    models.TextField(
                        blank=True, help_text="Last error message from failed publish attempt"
                    ),
                ),
            ],
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["status", "next_attempt_at"], name="events_outb_status_9dabce_idx"
                    ),
                    models.Index(
                        fields=["aggregate_type", "aggregate_id"],
